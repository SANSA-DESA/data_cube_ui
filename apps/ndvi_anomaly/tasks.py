...
@task(name="ndvi_anomaly.parse_parameters_from_task", base=BaseTask, bind=True)
...
@task(name="ndvi_anomaly.validate_parameters", base=BaseTask, bind=True)
...
@task(name="ndvi_anomaly.perform_task_chunking", base=BaseTask, bind=True)
...
@task(name="ndvi_anomaly.start_chunk_processing", base=BaseTask, bind=True)
...
@task(name="ndvi_anomaly.processing_task", acks_late=True, base=BaseTask, bind=True)
...
@task(name="ndvi_anomaly.recombine_geographic_chunks", base=BaseTask, bind=True)
...
@task(name="ndvi_anomaly.create_output_products", base=BaseTask, bind=True)
