...
@task(name="urbanization.parse_parameters_from_task", base=BaseTask, bind=True)
...
@task(name="urbanization.validate_parameters", base=BaseTask, bind=True)
...
@task(name="urbanization.perform_task_chunking", base=BaseTask, bind=True)
...
@task(name="urbanization.start_chunk_processing", base=BaseTask, bind=True)
...
@task(name="urbanization.processing_task", acks_late=True, base=BaseTask, bind=True)
...
@task(name="urbanization.recombine_time_chunks", base=BaseTask, bind=True)
...
@task(name="urbanization.process_band_math", base=BaseTask, bind=True)
...
@task(name="urbanization.recombine_geographic_chunks", base=BaseTask, bind=True)
...
@task(name="urbanization.create_output_products", base=BaseTask, bind=True)
